...
def get_the_city():
    ...
    if city == 'Chicago' or city == 'chicago' or city == 'C' or city == 'c':
        return 'chicago.csv'
    elif city == 'New York' or city == "N" or city == 'n' or city == 'new york':
        return 'new_york_city.csv'
    elif city == 'Washington' or city == 'washington' or city == 'w' or city == 'W':
        return 'washington.csv'
    else:
        print("\nI'm sorry, I'm not sure which city you're referring to. Let's gve it one more try again.")
        return get_the_city()


def get_the_time_period():
    ...
    if time_period == 'month' or time_period == 'm' or time_period == 'Month':
        return ['month', get_the_month()]
    elif time_period == 'day' or time_period == 'd' or time_period == 'Day':
        return ['day', get_the_day()]
    elif time_period == 'none' or time_period == 'n' or time_period == 'None':
        return ['none', 'no filter']
    else:
        print("\nI'm sorry, I'm not sure which time period you're trying to filter by. Let's try once again.")
        return get_the_time_period()
...
def get_the_month():
    ...
    '''
    month = input('\nWhich month you wish to look for? January, February, March, April, May, or June?\n').title()
    if month == 'January' :
        return '01'
    elif month == 'February':
        return '02'
        ...
        print("\nI'm sorry, I'm not sure which month you're trying to filter by. Let's try once again.")
        return get_the_month()
...
def get_the_day():
    ...
    '''
    day_of_week = input('\nWhich day of the week you are looking for? Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, or Sunday?\n').title()
    if day_of_week == 'Monday':
        ...
        print("\nI'm sorry, I'm not sure which day of the week you're looking to filter by. Let's try once again.")
        return get_the_day()
...
def common_month(df):
    ...
    return "Most common month for start time: " + calendar.month_name[int(trips_by_month.sort_values(ascending=False).index[0])]
...
def common_day(df):
    ...
    return "Most common day of the week for start time: " + calendar.day_name[int(trips_by_day_of_week.sort_values(ascending=False).index[0])]
...
def common_hour(df):
    ...
    return "Most common hour of the day for start time: " + d.strftime("%I %p")

def the_trip_duration(df):
...
def display_data(df, current_line):
    ...
    if display == 'yes' or display == 'y' or display == 'Yes':
        print(df.iloc[current_line:current_line+5])
        current_line += 5
        return display_data(df, current_line)
    if display == 'no' or display == 'n' or display == 'No' :
        return
    else:
        print("\nI'm sorry, I'm not sure if you wanted to see more data or not. please try again.")
        return display_data(df, current_line)
...
def statistics():
    ...
    def get_the_day_of_week(str_date):
    ...
    city_df['Day of Week'] = city_df['Start Time'].apply(get_the_day_of_week)
    ...
    time_period = get_the_time_period()
    ...
    trip_duration_stats = the_trip_duration(filtered_df)
    print(trip_duration_stats[0])
    print(trip_duration_stats[1])

    # What is the most popular start station and most popular end station?
    the_most_popular_stations = most_popular_stations(filtered_df)
    print(the_most_popular_stations[0])
    print(the_most_popular_stations[1])

    # What is the most popular trip?
    print(most_popular_trip(filtered_df))
